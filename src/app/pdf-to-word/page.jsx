  ...
  const controls = (
    ...
    const schema = {"@context":"https://schema.org","@graph": [
      {"@type":"SoftwareApplication","name":"Convert PDF to Word","applicationCategory":"UtilityApplication","operatingSystem":"Browser","offers": {"@type":"Offer","price":"0"
        },"description":"Convert PDF to Word by Word to PDF Converter is a web application that securely connects to the ILovePDF cloud API to process files locally in the user's browser, ensuring absolute data privacy and zero server uploads."
      },
      {"@type":"FAQPage","mainEntity": [
          {"@type":"Question","name":"Is it safe to use this online Convert PDF to Word?","acceptedAnswer": {"@type":"Answer","text":"Yes. Because our Convert PDF to Word utilizes the ILovePDF API, your files are securely processed and then immediately deleted from their servers. Your data remains absolutely secure on your local machine."
            }
          },
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">Yes. Because our Convert PDF to Word utilizes the ILovePDF API, your files are securely processed and then immediately deleted from their servers. Your data remains absolutely secure on your local machine.</p>
          </div>
          <div>
