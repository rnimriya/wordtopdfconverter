...
function ExtractPDFPages() {
  ...
  const handleExecute = async () => {
    ...
    try {
      ...
      formData.append('merge_after', 'true');
      ...
      let downloadName = `${file.name.replace(/\.[^/.]+$/, '')}-extracted.pdf`;
    ...
    <div className="space-y-4">
      ...
      <div className="p-3 bg-slate-950/40 border border-slate-850 rounded-xl space-y-1.5">
        ...
        <p className="text-[10px] text-slate-500 leading-normal">
          The extracted pages will be merged into a single PDF document.
        </p>
      </div>
    </div>
  );
  ...
  const seoContent = (
    <div className="prose prose-invert max-w-none space-y-8">
      <div className="space-y-4">
        <h1 className="text-3xl font-bold font-display text-white">Extract PDF Pages Quickly and Securely</h1>
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-white border-b border-slate-800 pb-2">How to Extract PDF Pages Online</h2>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">You sure can! Our website is fully optimized for mobile devices, so you can easily extract your online using your iPhone or Android browser—no extra apps required.</p>
          </div>
          <div>
