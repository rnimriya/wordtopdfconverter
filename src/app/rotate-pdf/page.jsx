      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">You sure can! Our website is fully optimized for mobile devices, so you can easily rotate your online using your iPhone or Android browser—no extra apps required.</p>
          </div>
          <div>
