...
function AssistantPdf() {
  ...
  const controls = (
    ...
    "url": "https://wordtopdfconverter.online/ai-pdf-assistant",
    "description": "A secure, fast, and free online tool to ai your PDF files with 100% precision.",
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">You sure can! Our website is fully optimized for mobile devices, so you can easily ai your online using your iPhone or Android browser—no extra apps required.</p>
          </div>
          <div>
