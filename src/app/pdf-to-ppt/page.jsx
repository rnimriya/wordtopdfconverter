...
function PdfToPpt() {
  ...
  const controls = (
    <div className="space-y-4">
      ...
      {"@type":"SoftwareApplication","name":"Convert PDF to PowerPoint","applicationCategory":"UtilityApplication","operatingSystem":"Browser","offers": {"@type":"Offer","price":"0"
        },"description":"Convert PDF to PowerPoint by Word to PDF Converter is a web application that securely connects to the ILovePDF cloud API to process files locally in the user's browser, ensuring absolute data privacy and zero server uploads."
      },
      {"@type":"FAQPage","mainEntity": [
          {"@type":"Question","name":"Is it safe to use this online Convert PDF to PowerPoint?","acceptedAnswer": {"@type":"Answer","text":"Yes. Because our Convert PDF to PowerPoint utilizes the ILovePDF API, your files are securely processed and then immediately deleted from their servers. Your data remains absolutely secure on your local machine."
            }
          },
    ...
    <div className="prose prose-invert max-w-none space-y-8">
      <div className="space-y-4">
        <h1 className="text-3xl font-bold font-display text-white">Secure Convert PDF to PowerPoint - 100% Private Browser Processing</h1>
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-white border-b border-slate-800 pb-2">How It Works: Local Convert PDF to PowerPoint Processing</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-500">The ILovePDF API uses state-of-the-art document processing technology to ensure perfect conversions.</p>
          </div>
          <div className="space-y-2">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-bold text-white">Is it safe to use this online Convert PDF to PowerPoint?</h3>
            <p className="text-slate-400 text-sm mt-1">Yes. Because our Convert PDF to PowerPoint utilizes the ILovePDF API, your files are securely processed and then immediately deleted from their servers. Your data remains absolutely secure on your local machine.</p>
          </div>
          <div>
