...
function OCRPdf() {
  ...
  const handleExecute = async () => {
    ...
    try {
      ...
      downloadName = `${file.name.replace(/\.[^/.]+$/, '')}-ocr.pdf`;
    ...
    <div className="space-y-4">
      ...
      <div className="p-3 bg-slate-950/40 border border-slate-850 rounded-xl space-y-1.5">
        ...
        <p className="text-[10px] text-slate-500 leading-normal">
          This will make scanned text selectable and searchable using OCR.
        </p>
      </div>
    </div>
  );
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">You sure can! Our website is fully optimized for mobile devices, so you can easily ocr your online using your iPhone or Android browser—no extra apps required.</p>
          </div>
          <div>
