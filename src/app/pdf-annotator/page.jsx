...
function PDFAnnotator() {
  ...
  const schema = {
    ...
    "description": "PDF Annotator locally in your browser.",
  ...
  const seoContent = (
    <div className="prose prose-invert max-w-none space-y-8">
      <div className="space-y-4">
        <h1 className="text-3xl font-bold font-display text-white">Secure PDF Annotator - 100% Private Local Processing</h1>
